...
import { getUsuariosService, getUsuarioByUidService } from "../service/users.service.ts";
...
export const getUsuarioPerfil = async (ctx: RouterContext<string>) => {
    try {
        ...
        ctx.response.body = { success: false, message: "Error obteniendo el perfil del usuario", error: errorMessage };
    }
};